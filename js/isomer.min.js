...
!function(t){function n(t){this.points="[object Array]"===Object.prototype.toString.call(t)?t:Array.prototype.slice.call(arguments)}n.prototype.push=function(t){this.points.push(t)},n.prototype.reverse=function(){var t=Array.prototype.slice.call(this.points);return new n(t.reverse())},n.prototype.translate=function(){var t=arguments;return new n(this.points.map(function(n){return n.translate.apply(n,t)}))},n.prototype.rotateZ=function(){var t=arguments;return new n(this.points.map(function(n){return n.rotateZ.apply(n,t)}))},n.prototype.scale=function(){var t=arguments;return new n(this.points.map(function(n){return n.scale.apply(n,t)}))},n.prototype.depth=function(){var t,n=0;for(t=0;t<this.points.length;t++)n+=this.points[t].depth();return n/(this.points.length||1)},n.Rectangle=function(t,r,e){void 0===r&&(r=1),void 0===e&&(e=1);var o=new n([t,new Point(t.x+r,t.y,t.z),new Point(t.x+r,t.y+e,t.z),new Point(t.x,t.y+e,t.z)]);return o},n.Circle=function(t,r,e){e=e||20;var o,a=new n;for(o=0;e>o;o++)a.push(new Point(r*Math.cos(2*o*Math.PI/e),r*Math.sin(2*o*Math.PI/e),0));return a.translate(t.x,t.y,t.z)},n.Star=function(t,r,e,o){var a,i,p=new n;for(a=0;2*o>a;a++)i=a%2===0?r:e,p.push(new Point(i*Math.cos(a*Math.PI/o),i*Math.sin(a*Math.PI/o),0));return p.translate(t.x,t.y,t.z)},t.Path=n}(Isomer);
!function(t){function n(t,e,r){return this instanceof n?(this.x="number"==typeof t?t:0,this.y="number"==typeof e?e:0,this.z="number"==typeof r?r:0,void 0):new n(t,e,r)}n.ORIGIN=new n(0,0,0),n.prototype.translate=function(t,e,r){return new n(this.x+t,this.y+e,this.z+r)},n.prototype.scale=function(t,n,e,r){var o=this.translate(-t.x,-t.y,-t.z);return void 0===e&&void 0===r?e=r=n:r="number"==typeof r?r:1,o.x*=n,o.y*=e,o.z*=r,o.translate(t.x,t.y,t.z)},n.prototype.rotateZ=function(t,n){var e=this.translate(-t.x,-t.y,-t.z),r=e.x*Math.cos(n)-e.y*Math.sin(n),o=e.x*Math.sin(n)+e.y*Math.cos(n);return e.x=r,e.y=o,e.translate(t.x,t.y,t.z)},n.prototype.depth=function(){return this.x+this.y-2*this.z},n.distance=function(t,n){var e=n.x-t.x,r=n.y-t.y,o=n.z-t.z;return Math.sqrt(e*e+r*r+o*o)},t.Point=n}(Isomer);
!function(t){function e(t){this.paths="[object Array]"===Object.prototype.toString.call(t)?t:Array.prototype.slice.call(arguments)}e.prototype.push=function(t){this.paths.push(t)},e.prototype.translate=function(){var t=arguments;return new e(this.paths.map(function(e){return e.translate.apply(e,t)}))},e.prototype.rotateZ=function(){var t=arguments;return new e(this.paths.map(function(e){return e.rotateZ.apply(e,t)}))},e.prototype.scale=function(){var t=arguments;return new e(this.paths.map(function(e){return e.scale.apply(e,t)}))},e.prototype.orderedPaths=function(){var t=this.paths.slice();return t.sort(function(t,e){return e.depth()-t.depth()})},e.extrude=function(t,n){n="number"==typeof n?n:1;var r,s=t.translate(0,0,n),a=new e;for(a.push(t.reverse()),a.push(s),r=0;r<t.points.length;r++)a.push(new Path([s.points[r],t.points[r],t.points[(r+1)%t.points.length],s.points[(r+1)%s.points.length]]));return a},e.Prism=function(t,n,r,s){n="number"==typeof n?n:1,r="number"==typeof r?r:1,s="number"==typeof s?s:1;var a=Isomer.Path,p=Isomer.Point,o=new e,u=new a([t,new p(t.x+n,t.y,t.z),new p(t.x+n,t.y,t.z+s),new p(t.x,t.y,t.z+s)]);o.push(u),o.push(u.reverse().translate(0,r,0));var h=new a([t,new p(t.x,t.y,t.z+s),new p(t.x,t.y+r,t.z+s),new p(t.x,t.y+r,t.z)]);o.push(h),o.push(h.reverse().translate(n,0,0));var i=new a([t,new p(t.x+n,t.y,t.z),new p(t.x+n,t.y+r,t.z),new p(t.x,t.y+r,t.z)]);return o.push(i.reverse()),o.push(i.translate(0,0,s)),o},e.Pyramid=function(t,n,r,s){n="number"==typeof n?n:1,r="number"==typeof r?r:1,s="number"==typeof s?s:1;var a=Isomer.Path,p=Isomer.Point,o=new e,u=new a([t,new p(t.x+n,t.y,t.z),new p(t.x+n/2,t.y+r/2,t.z+s)]);o.push(u),o.push(u.rotateZ(t.translate(n/2,r/2),Math.PI));var h=new a([t,new p(t.x+n/2,t.y+r/2,t.z+s),new p(t.x,t.y+r,t.z)]);return o.push(h),o.push(h.rotateZ(t.translate(n/2,r/2),Math.PI)),o},e.Cylinder=function(t,n,r,s){n="number"==typeof n?n:1;var a=Isomer.Path,p=a.Circle(t,n,r),o=e.extrude(p,s);return o},t.Shape=e}(Isomer);
!function(t){function i(t,i,n){this.i="number"==typeof t?t:0,this.j="number"==typeof i?i:0,this.k="number"==typeof n?n:0}i.fromTwoPoints=function(t,n){return new i(n.x-t.x,n.y-t.y,n.z-t.z)},i.crossProduct=function(t,n){var r=t.j*n.k-n.j*t.k,o=-1*(t.i*n.k-n.i*t.k),e=t.i*n.j-n.i*t.j;return new i(r,o,e)},i.dotProduct=function(t,i){return t.i*i.i+t.j*i.j+t.k*i.k},i.prototype.magnitude=function(){return Math.sqrt(this.i*this.i+this.j*this.j+this.k*this.k)},i.prototype.normalize=function(){var t=this.magnitude();return new i(this.i/t,this.j/t,this.k/t)},t.Vector=i}(Isomer);